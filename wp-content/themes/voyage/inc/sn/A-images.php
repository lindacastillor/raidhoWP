...
elseif (get_sub_field('choose') == 'thirds-slider-middle') : ?>
		<div class="bl-party-img-slider-third sldr-middle">
			<div class="slider">
				<div>
					<picture>
			...
			<div class="slider">
				<style>
					.bl-party-img-slider-third.sldr-middle .slider ul.centered-btns_tabs li a{
						border: 4px solid <?php the_sub_field('bg-color'); ?>;}
					.bl-party-img-slider-third.sldr-middle .slider a.centered-btns_nav.next:hover,
					.bl-party-img-slider-third.sldr-middle .slider a.centered-btns_nav.prev:hover{
						background-color: <?php the_sub_field('bg-color'); ?>;}
					.bl-party-img-slider-third.sldr-middle .slider ul.centered-btns_tabs li a:hover,
					.bl-party-img-slider-third.sldr-middle .slider ul.centered-btns_tabs li.centered-btns_here a{
						background-color: <?php the_sub_field('bg-color'); ?>;
						border: 4px solid <?php the_sub_field('bg-color'); ?>;}
				</style>
				<?php
